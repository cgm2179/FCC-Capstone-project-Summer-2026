...
| `Frontend/landing/` | Indoor/Outdoor · 2D/3D router |
| `Map Coverage/` | Map Coverage tab (dashboard + outdoor view + 3D CAD) |
| `Statistics/` | Statistics tab (spectrum) |
| `Time Elapse/` | Outdoor Time Elapse iframe |
| `Simulation/` | Full-Wave studios + sim helpers |
| `Data + Model/` | walk payloads + CAD (`Data/` symlink kept) |
